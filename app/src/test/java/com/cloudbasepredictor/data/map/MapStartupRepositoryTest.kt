...
class MapStartupRepositoryTest {
    ...
    fun defaultStartsWithFavorites() {
        val repository = SharedPrefsMapStartupRepository(FakeSharedPreferences())

        assertEquals(true, repository.startWithFavorites.value)
    }

    @Test
    fun setStartWithFavorites_persistsToPreferences() {
        val prefs = FakeSharedPreferences()
        val repository = SharedPrefsMapStartupRepository(prefs)
