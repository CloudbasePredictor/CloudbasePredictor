...
object ForecastTestTags {
    ...
    const val THERMIC_RENDERER_DESCRIPTION = "Thermic forecast chart renderer"
    const val THERMIC_CURSOR_PANEL = "forecast_thermic_cursor_panel"
    const val STUVE_VIEW = "forecast_view_stuve"
    const val STUVE_RENDERER_DESCRIPTION = "Stüve forecast chart renderer"
    const val WIND_VIEW = "forecast_view_wind"
    const val WIND_RENDERER_DESCRIPTION = "Wind forecast chart renderer"
    const val CLOUD_VIEW = "forecast_view_cloud"
    const val CLOUD_RENDERER_DESCRIPTION = "Cloud forecast chart renderer"
