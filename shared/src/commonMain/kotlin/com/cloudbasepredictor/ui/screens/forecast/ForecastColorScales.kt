...
const val THERMIC_STRENGTH_COLOR_SCALE_MAX_MPS = 5f
const val WIND_SPEED_COLOR_SCALE_MAX_KMH = 60f
...
fun thermicStrengthColor(strengthMps: Float): Color {
...
fun windSpeedColor(speedKmh: Float): Color {
    return interpolateColorStops(
