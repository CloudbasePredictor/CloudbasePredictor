...
const val SKEWT_MIN_TOP_PRESSURE = 250f
const val SKEWT_BOTTOM_PRESSURE = 1050f
internal const val SKEWT_SKEW_RATIO = 0.45f
private const val STUVE_TEMP_AXIS_HALF_WIDTH_C = 20f

val STUVE_DRY_REFERENCE_PRESSURES = listOf(
...
fun recommendedStuveTopAltitudeKm(chart: StuveForecastChartUiModel): Float {
 ...
 */
fun shouldDrawDefaultParcelGuide(isCursorActive: Boolean): Boolean = !isCursorActive
...
fun buildTemperatureAxisLabels(range: TempAxisRange): List<Float> {
 ...
 */
fun buildInteractiveParcelFromPoint(
 ...
 */
fun buildInteractiveParcelFromSurface(
